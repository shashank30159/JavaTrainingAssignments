package com.vm.training.java.assignment.oops.cafeteriaproject;

public abstract class CustomerDetails implements Customer
{
	String customer_name; 
	int customer_id; 
	int customer_table_number;
	int customer_discountOnAppliedCoupon;
	String customer_BookiedTimeTill; 
	long customer_phnum;
